...
from model.data_loader import load_data, get_data_iterator
...
parser.add_argument('--dataset', default='data01', type=str, help='define your own dataset names')
...
if __name__ == '__main__':
    model = CasRel(con).to(con.device)
